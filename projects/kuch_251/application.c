...
void ApplicationPressed2_1(void) {
  ...
  if ((state == eShaderClosing) || (state == eShaderOpening)) {
	 ...
	 if(ShaderGetLastAction(eShader2,&action)){
...
void ApplicationPressed3_0(void) {
	DigOutToggle(eDigOut16); //Aussenlicht
}
...
void ApplicationPressed3_1(void) {
	  ...
	  if ((state == eShaderClosing) || (state == eShaderOpening)) {
         ...
         if(ShaderGetLastAction(eShader5,&action)){
	        if(action==eStateOpen) {
...
void ApplicationPressed5_0(void) {
	  ...
	  if ((state == eShaderClosing) || (state == eShaderOpening)) {
         ...
         if(ShaderGetLastAction(eShader1,&action)){
	        if(action==eStateClose) {
...
void ApplicationPressed14_0(void) {
	  ...
	  if ((state == eShaderClosing) || (state == eShaderOpening)) {
         ...
         if(ShaderGetLastAction(eShader3,&action)){
	        if(action==eStateOpen) {
...
void ApplicationPressed14_1(void) {
	  ...
	  if ((state == eShaderClosing) || (state == eShaderOpening)) {
         ...
         if(ShaderGetLastAction(eShader4,&action)){
	        if(action==eStateOpen) {
...
void ApplicationPressed38_0(void) {
	  ...
	  if ((state == eShaderClosing) || (state == eShaderOpening)) {
         ...
         if(ShaderGetLastAction(eShader6,&action)){
	        if(action==eStateOpen) {
...
void ApplicationPressed42_0(void) {
	DigOutDelayedOff(eDigOut21,1000UL*60UL*10UL);
}
...
void ApplicationPressed51_0(void) {
	DigOutDelayedOff(eDigOut24, 60UL*60UL*2UL*1000UL);
}
...
void ApplicationPressed52_1(void) {
	//Lüfter
	DigOutDelayedOff(eDigOut23, 15UL*60UL*1000UL);
}
