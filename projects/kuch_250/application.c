...
void ApplicationInit(void) {
   /* eShader0 WC - Bad EG */
   ShaderSetConfig(eShader0, eDigOut0, eDigOut1, 60000, 60000);
   /* eShader1 Büro */
   ShaderSetConfig(eShader1, eDigOut2, eDigOut3, 60000, 60000);  
   /* eShader2 Fenster WZ */
   ShaderSetConfig(eShader2, eDigOut4, eDigOut5, 60000, 60000);
   /* eShader3 Terasse WZ rechts Res */
   ShaderSetConfig(eShader3, eDigOut6, eDigOut7, 60000, 60000); 
   /* eShader4 Terasse WZ links */
   ShaderSetConfig(eShader4, eDigOut8, eDigOut9, 60000, 60000);
   /* eShader5 Esszimmer */
   ShaderSetConfig(eShader5, eDigOut10, eDigOut11, 60000, 60000);
   /* eShader6 Terasse rechts Res */
   ShaderSetConfig(eShader6, eDigOut12, eDigOut13, 60000, 60000);
   /* eShader7 Terasse links */
   ShaderSetConfig(eShader7, eDigOut15, eDigOut14, 60000, 60000); 
   /* eShader8 Küche */
   ShaderSetConfig(eShader8, eDigOut17, eDigOut16, 60000, 60000);
   }
   
// eDigOut0		Technik
// eDigOut1		Waschr.
// eDigOut27	Keller Klein
// eDigOut28	Keller Groß
// eDigOut29	Aussen 3
// eDigOut30	res
...
void ApplicationPressed23_0(void) {
	DigOutDelayedOff(eDigOut22, 60UL*60UL*2UL*1000UL);
}
...
void ApplicationPressed24_0(void) {
	DigOutDelayedOff(eDigOut21, 10UL*60UL*1000UL);	
}
...
void ApplicationPressed25_0(void) {
	DigOutToggle(eDigOut23);	// Spiegel	Bad EG
}
void ApplicationReleased25_0(void) {}
void ApplicationPressed25_1(void) {
	DigOutToggle(eDigOut24);	// Haupt		
}
...
void ApplicationPressed32_0(void) {
	DigOutToggle(eDigOut19);	// Küche Kasten
}
...
void ApplicationPressed32_1(void) {
	//* Alle Küche auf/ab	
      ...
      TShaderLastAction action;
  	  ...
  	  ShaderGetState(eShader7, &state);
	  if ((state == eShaderClosing) || (state == eShaderOpening)) {
		 ShaderSetAction(eShader5, eShaderStop);
	     ShaderSetAction(eShader7, eShaderStop);
		 ShaderSetAction(eShader8, eShaderStop);
	     }
	  else {
         if(ShaderGetLastAction(eShader7,&action)){
	        if(action==eStateOpen) {
		       ShaderSetAction(eShader5, eShaderClose);
			   ShaderSetAction(eShader7, eShaderClose);
			   ShaderSetAction(eShader8, eShaderClose);
		    }
...
void ApplicationPressed36_1(void) {
	DigOutToggle(eDigOut27);	// WZ groß	
}
...
void ApplicationPressed60_1(void) {
	DigOutToggle(eDigOut26);	// Aussen WZ	
}
