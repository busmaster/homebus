...
#include <ESP8266HTTPUpdateServer.h>
  ...
  const char* mqtt_in_topic = "home/eg/arbeit/schreibtisch/set";
  const char* mqtt_out_topic = "home/eg/arbeit/schreibtisch/actual";
